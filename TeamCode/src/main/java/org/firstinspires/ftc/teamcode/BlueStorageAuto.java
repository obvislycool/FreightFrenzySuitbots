...
@Autonomous(name="Blue Storage Auto", group="Pushbot")
//@Disabled
public class BlueStorageAuto extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        encoderDrive(DRIVE_SPEED,  5,  5, 4.0);  // S1: Forward 47 Inches with 5 Sec timeout
        encoderDrive(TURN_SPEED,   +20, -20, 5.0);  // S2: Turn Left 12 Inches with 4 Sec timeout
        encoderDrive(0.2, 17, 17 , 5.0);  // S3: Reverse 24 Inches with 4 Sec timeout
        duckSpin(CLOCKWISE,6000);
        encoderDrive(TURN_SPEED,   -20, +20, 5.0);  // S2: Turn Left 12 Inches with 4 Sec timeout
        encoderDrive(DRIVE_SPEED,  20,  20, 6.0);  // S1: Forward 47 Inches with 5 Sec timeout
        encoderDrive(TURN_SPEED,  +20,  -20, 5.0);  // S1: Forward 47 Inches with 5 Sec timeout
        encoderDrive(DRIVE_SPEED,  5,  5, 4.0);  // S1: Forward 47 Inches with 5 Sec timeout
