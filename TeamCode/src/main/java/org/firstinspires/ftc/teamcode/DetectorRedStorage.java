...
@Autonomous(name = "DetectorRedStorage", group = "Auto")
public class DetectorRedStorage extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        encoderDrive(TURN_SPEED,  -28,  28, 6.0); //turn to face away from depot
        encoderDrive(DRIVE_SPEED,  20,  20, 7.0); //back into depot full speed
